...
@implementation YBVideoCompressTools
/**
 压缩视频的方法
 ...
 */
+ (void)compressVideoWithSourceVideoPath:(NSString *)sourceVideoPath CompressType:(NSString *)compressType CompressSuccessBlock:(YBSuccessBlock)compressSuccessBlock CompressFailedBlock:(YBFailedBlock)compressFailedBlock CompressNotSupportBlock:(YBNotSupportBlock)compressNotSupportBlock {
    // 源视频路径
