...
#import "YBCalendarReminderManager.h"

@implementation YBCalendarReminderManager
...
{
    EKEventStore *store = [YBCalendarReminderManager manager];
...
{
   return [[YBCalendarReminderManager manager] eventWithIdentifier:eventIdentifer];
}
